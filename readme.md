## **Событийный плагин v1.1**

- сделаны интернационализация  i18n
- и локализация l10n
- разнесены сущности по классам (виджет отдельно, аргументы для Цикла - отдельно)



## **Событийный плагин v1.0**
...
Если его деактивировать, то результат на странице https://palmplay.pp.ua/shop/ будет унылым:
...
- обеспечить переиспользование кода (к примеру массивов параметров в циклах WP),
